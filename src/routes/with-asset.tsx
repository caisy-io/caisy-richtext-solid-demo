import { RichTextRenderer } from "@caisy/rich-text-solid-renderer";

export const SAMPLE_RICHTEXT_FIELD_DATA_WITH_CONNECTIONS = {
  connections: [
    {
      description: "",
    ...
    <main class="text-center mx-auto text-gray-700 p-4">
      <div class="flex justify-center align-center">
        <div class="prose lg:prose-xl">
          <RichTextRenderer node={SAMPLE_RICHTEXT_FIELD_DATA_WITH_CONNECTIONS.json} overwrites={
            {
              "documentLink": ({node}: {node: {attrs: {documentId: string}}}) => {
                const linkedAsset = SAMPLE_RICHTEXT_FIELD_DATA_WITH_CONNECTIONS.connections.find((connection) => connection.id === node.attrs.documentId);
